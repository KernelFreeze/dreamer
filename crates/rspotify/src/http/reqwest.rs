...
impl ReqwestClient {
    async fn request<D>(
        &self, method: Method, url: &str, headers: Option<&Headers>, add_data: D,
    ) -> ClientResult<String>
    where
...
impl BaseHTTPClient for ReqwestClient {
    #[inline]
    async fn get(
        &self, url: &str, headers: Option<&Headers>, payload: &Query,
    ) -> ClientResult<String> {
    ...
    #[inline]
    async fn post(
        &self, url: &str, headers: Option<&Headers>, payload: &Value,
    ) -> ClientResult<String> {
    ...
    #[inline]
    async fn post_form(
        &self, url: &str, headers: Option<&Headers>, payload: &Form,
    ) -> ClientResult<String> {
