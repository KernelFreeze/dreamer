...
impl Spotify {
    ...
    pub async fn tracks<'a>(
        &self, track_ids: impl IntoIterator<Item = &'a str>, market: Option<Market>,
    ...
    pub async fn artists<'a>(
        &self, artist_ids: impl IntoIterator<Item = &'a str>,
    ...
    pub async fn artist_albums(
        &self, artist_id: &str, album_type: Option<AlbumType>, market: Option<Market>,
    ...
    pub async fn artist_top_tracks(
        &self, artist_id: &str, market: Market,
    ) -> ClientResult<Vec<FullTrack>> {
    ...
    pub async fn albums<'a>(
        &self, album_ids: impl IntoIterator<Item = &'a str>,
    ...
    pub async fn search<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, q: &str, _type: SearchType, limit: L, offset: O, market: Option<Market>,
    ...
    pub async fn album_track<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, album_id: &str, limit: L, offset: O,
    ...
    pub async fn playlist(
        &self, playlist_id: &str, fields: Option<&str>, market: Option<Market>,
    ...
    pub async fn user_playlists<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, user_id: &str, limit: L, offset: O,
    ) -> ClientResult<Page<SimplifiedPlaylist>> {
        let mut params = Query::with_capacity(2);
        params.insert("limit".to_owned(), limit.into().unwrap_or(50).to_string());
        params.insert("offset".to_owned(), offset.into().unwrap_or(0).to_string());
    ...
    pub async fn user_playlist(
        &self, user_id: &str, playlist_id: Option<&mut str>, fields: Option<&str>,
    ) -> ClientResult<FullPlaylist> {
        let mut params = Query::new();
        if let Some(fields) = fields {
    ...
    pub async fn playlist_tracks<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, playlist_id: &str, fields: Option<&str>, limit: L, offset: O, market: Option<Market>,
    ...
    pub async fn user_playlist_create<P: Into<Option<bool>>, D: Into<Option<String>>>(
        &self, user_id: &str, name: &str, public: P, description: D,
    ) -> ClientResult<FullPlaylist> {
    ...
    pub async fn playlist_change_detail(
        &self, playlist_id: &str, name: Option<&str>, public: Option<bool>,
        description: Option<String>, collaborative: Option<bool>,
    ) -> ClientResult<String> {
        let mut params = json!({});
    ...
    pub async fn playlist_add_tracks<'a>(
        &self, playlist_id: &str, track_ids: impl IntoIterator<Item = &'a str>,
        position: Option<i32>,
    ...
    pub async fn playlist_reorder_tracks<R: Into<Option<u32>>>(
        &self, playlist_id: &str, range_start: i32, range_length: R, insert_before: i32,
    ...
    pub async fn playlist_remove_specific_occurrences_of_tracks(
        &self, playlist_id: &str, tracks: Vec<Map<String, Value>>, snapshot_id: Option<String>,
    ) -> ClientResult<PlaylistResult> {
        // TODO: this can be improved
        let plid = self.get_id(Type::Playlist, playlist_id);
    ...
    pub async fn playlist_check_follow(
        &self, playlist_id: &str, user_ids: &[String],
    ...
    pub async fn current_user_followed_artists<L: Into<Option<u32>>>(
        &self, limit: L, after: Option<String>,
    ...
    pub async fn current_user_saved_tracks_delete<'a>(
        &self, track_ids: impl IntoIterator<Item = &'a str>,
    ) -> ClientResult<()> {
        let uris: Vec<String> = track_ids
            .into_iter()
    ...
    >(
        &self, limit: L, offset: O, time_range: T,
    ...
    pub async fn user_artist_check_follow<'a>(
        &self, artsit_ids: impl IntoIterator<Item = &'a str>,
    ) -> ClientResult<Vec<bool>> {
        let url = format!(
    ...
    pub async fn user_follow_users<'a>(
        &self, user_ids: impl IntoIterator<Item = &'a str>,
    ) -> ClientResult<()> {
        let url = format!(
    ...
    ///   language code and an uppercase ISO 3166-1 alpha-2 country code, joined
    ///   by an underscore.
    ...
    /// - limit - The maximum number of items to return. Default: 20. Minimum:
    ///   1. Maximum: 50
    ...
    pub async fn featured_playlists<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, locale: Option<String>, country: Option<Market>, timestamp: Option<DateTime<Utc>>,
        limit: L, offset: O,
    ...
    pub async fn new_releases<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, country: Option<Market>, limit: L, offset: O,
    ) -> ClientResult<Page<SimplifiedAlbum>> {
        let mut params = Query::with_capacity(2);
        params.insert("limit".to_owned(), limit.into().unwrap_or(20).to_string());
        params.insert("offset".to_owned(), offset.into().unwrap_or(0).to_string());
    ...
    pub async fn categories<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, locale: Option<String>, country: Option<Market>, limit: L, offset: O,
    ...
    pub async fn category_playlists<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, category_id: &str, country: Option<Market>, limit: L, offset: O,
    ) -> ClientResult<Page<SimplifiedPlaylist>> {
        let mut params = Query::with_capacity(2);
        params.insert("limit".to_owned(), limit.into().unwrap_or(20).to_string());
        params.insert("offset".to_owned(), offset.into().unwrap_or(0).to_string());
    ...
    pub async fn recommendations<L: Into<Option<u32>>>(
        &self, seed_artists: Option<Vec<String>>, seed_genres: Option<Vec<String>>,
        seed_tracks: Option<Vec<String>>, limit: L, market: Option<Market>,
    ...
    pub async fn tracks_features<'a>(
        &self, tracks: impl IntoIterator<Item = &'a str>,
    ...
    pub async fn current_playback(
        &self, market: Option<Market>, additional_types: Option<Vec<AdditionalType>>,
    ...
    pub async fn transfer_playback<T: Into<Option<bool>>>(
        &self, device_id: &str, force_play: T,
    ) -> ClientResult<()> {
        self.endpoint_put(
            "me/player",
            &json! ({
    ...
    pub async fn start_playback(
        &self, device_id: Option<String>, context_uri: Option<String>, uris: Option<Vec<String>>,
        offset: Option<super::model::Offset>, position_ms: Option<u32>,
    ) -> ClientResult<()> {
    ...
    pub async fn seek_track(
        &self, position_ms: u32, device_id: Option<String>,
    ) -> ClientResult<()> {
    ...
    pub async fn add_item_to_queue(
        &self, item: String, device_id: Option<String>,
    ) -> ClientResult<()> {
    ...
    ///
    /// Query Parameters
    /// - ids(Required) A comma-separated list of the Spotify IDs for the shows.
    ///   Maximum: 50 IDs.
    /// - market(Optional) An ISO 3166-1 alpha-2 country code or the string
    ///   from_token.
    ///
    ...
    pub async fn get_several_shows<'a>(
        &self, ids: impl IntoIterator<Item = &'a str>, market: Option<Market>,
    ...
    /// - offset: Optional. The index of the first episode to return. Default: 0
    ///   (the first object). Use with limit to get the next set of episodes.
    /// - market: Optional. An ISO 3166-1 alpha-2 country code or the string
    ///   from_token.
    ///
    ...
    pub async fn get_shows_episodes<L: Into<Option<u32>>, O: Into<Option<u32>>>(
        &self, id: String, limit: L, offset: O, market: Option<Market>,
    ...
    pub async fn get_an_episode(
        &self, id: String, market: Option<Market>,
    ...
    ///
    /// Query Parameters
    /// - ids: Required. A comma-separated list of the Spotify IDs for the
    ...
    pub async fn check_users_saved_shows<'a>(
        &self, ids: impl IntoIterator<Item = &'a str>,
    ) -> ClientResult<Vec<bool>> {
        let mut params = Query::with_capacity(1);
        params.insert(
            "ids".to_owned(),
    ...
    /// Changes to a user's saved shows may not be visible in other Spotify
